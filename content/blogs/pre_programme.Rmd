...
description: It's my pre-programme project for Data Analytics
draft: false
image: pic07.jpg
keywords: ""
slug: aliquam
...
Hi, guys!  My name is Shuyan Zou, an MFA student from LBS. I come from Shanghai, China.
...
### **Linkedin**
Please add my Linkedin if you have similiar career path with me  
<* *>
...
> Fist of all, the life expectancy in each continent has been increasing since 1952. However, the life expectancy in Africa didn't grow much from 1990 to 2010. The average life expectancy of Asian countries is growing most rapidly among all the continents, possibly becuase Asian economy thrived throughout the years and so that people were able to increase their life quality and in the meantime led to longer longevity.
...
ggplot(brexit_results, aes(x = leave_share)) +
  ...
  labs(title = " Histogram for Percentage of Votes Cast in Favour of Brexit ",
       x = "leave_share",
       y = "count") 
...
ggplot(brexit_results, aes(x = leave_share)) +
  geom_density()+
  labs(title = " Smoothed Histogram for Percentage of Votes Cast in Favour of Brexit ",
       x = "leave_share",
       y = "density") 
...
ggplot(brexit_results, aes(x = leave_share)) +
  ...
  labs(title = " Empirical Cumulative Distribution Function for percentage of votes supporting Brexit ",
       x = "leave_share",
...
> Firstly, "leave_share" and "born_in_uk", are positively correlated, which quite make senses since people in UK are quite against the open border policy of EU. In this way, we can imagine those UK natives will support Brexit so as to resist the open border policy for the immigrates.
...
> The percentage of tiny parts of other animal group is under 0.6 in this case, which will not be displayed in the result.
...
> In each animal group, mean and median are different. Mean shows average level which is easily affected by outliers. However, while median shows the middle level cost among each animal group.

> As to horse and cow, the incident cost is much higher compared with other animals, which indicate that there would be more potential outliers of incident cost.
...
> Boxplot is the best illustration of the variability of the "incident_notional_cost" among different animal groups.

> Horse and Cow are more expensive to rescue than others. Bird, cat, dag and fox have more outliers. The underlying reason might be that most household pets belong to those animal groups, so large population results into many different cases of incident notional cost.
...
-   What, if anything, gave you the most trouble: understand the meaning of the codes
